                ...
                <div className="mainDiv">
                    ...
                    <p>
                        This app is intended to be a starter/tutorial app for your upcoming
                          project and a learning sandbox for you in month and years to Component
                          ...
                          build out some small applications, and then unleash you to buildyour own applications.
                    </p>
                    <hr />
                    ...
                    <ul>
                        ...
                        <li>
                            We have tried to collect the very best resources for this app, and we have
                            cited those <Link to="/resources">here</Link>
                        </li>
                        <li>
                            The set up for this app might be the most confusing part. Hang in there.
                        </li>
                        <li>
