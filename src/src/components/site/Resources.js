    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>Below are some of the resource that we used throughout this app. note: You'll have one challenge where you will be asked to make this page better.'</p>
                <ul>
                    <li>The Official Docs</li>
                    <li>React Router Dom</li>
                    <li>Stephen Grider's Udemy Course fot the Udemy API. He's all over the place.</li>
                    <li>Samer Buna's Pluralsignt Course for the Github API Starter.</li>
                    <li>reactstrap for a Bootstrap app</li>
                    <li>The Moviee App</li>
                    <li>Front Awesome for React: https://gorangajic.github.io/react-icons/fa.html</li>
